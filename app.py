...
def predict():
    try:
        # Retrieve form data and data type conversion
        ...
        fuel = form_data['fuel']  # Diesel, Petrol, LPG/CNG.
        seller_type = form_data['seller_type']  #  Individual, Dealer
        transmission = form_data['transmission']  #  Manual, Automatic
